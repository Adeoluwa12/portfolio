const FALLBACK_CERTS = [
  ...
  { code: "SC-401", name: "Information Security Administrator Associate", issuer: "Microsoft" },
  { code: "SC-500", name: "Microsoft Cloud and AI Security Engineer Associate", issuer: "Microsoft" },
  { code: "SC-900", name: "Security, Compliance, and Identity Fundamentals", issuer: "Microsoft" },
  { code: "AZ-900", name: "Azure Fundamentals", issuer: "Microsoft" },
  { code: "KCNA", name: "Kubernetes and Cloud Native Associate", issuer: "CNCF" },
];

export default function CredentialsVault({ certifications }: { certifications?: any[] }) {
  const data = certifications?.length ? certifications : FALLBACK_CERTS;
  ...
  return (
    <section id="certifications" className="max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {data.map((cert: any) => (
          <div key={cert.code} className="card p-5 flex flex-col gap-2 hover:border-accent/30 group">
